  ...
  <body>
    ...
    <form action="register" method="post">
      ...
      <div class="checkbox-group">
        <label
          ><input type="checkbox" name="favorites" value="music" /> Music</label
        >
        <label
          ><input type="checkbox" name="favorites" value="art" /> Art</label
        >
        <label
          ><input type="checkbox" name="favorites" value="sports" />
          Sports</label
        >
        <label
